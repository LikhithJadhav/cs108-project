document.getElementById('moddagud').addEventListener('click', function(event) {
    ...
    const gender = document.querySelector('input[name="authOption"]:checked').value;
    ...
    fetch("students.json")
        ...
        .then((students) => {
            ...
            if (formData.gender === 'Male') {
                oppGenderStudents = students.filter(student => student.Gender === 'Female' );
            } else if (formData.gender === 'Female') {
                oppGenderStudents = students.filter(student => student.Gender === 'Male' );
            } else {    
                oppGenderStudents = students.filter(student => student.Gender !== formData.gender);
            }
